...
1. **多课程支持**：支持金融学基础、线性代数和中国金融学三门课程，可在侧边栏自由切换
...
### 侧边栏
- 学生ID输入：用于标识学生身份
- 课程选择：可在"金融学基础"、"线性代数"和"中国金融学"之间切换
...
1. ✅ 多课程支持（金融学基础、线性代数和中国金融学）
2. ✅ 独立的课程状态管理
3. ✅ LaTeX 数学公式渲染（题目、选项、解析均支持，使用 st.markdown 原生渲染）
4. ✅ 侧边栏显示/隐藏控制
5. ✅ 课程切换时内容自动更新
6. ✅ 从Excel知识图谱导入并生成图谱JSON（中国金融学，22个知识点，含前驱关系）
7. ✅ 基于知识图谱节点生成多层级试题（memory/understanding/application，共66道）
8. ✅ 试题数据 LaTeX 公式规范化（修复转义问题，统一使用 $...$ 包裹数学表达式）
